...
<div class="jumbotron jumbotron-fluid">
  ...
  <div class="container" style="padding: 5px;">
    <h4 style="display: inline;"><strong>New Arrivals :</strong></h4><hr>
    <div class="row">
      <?php
      
      
      $sql_fetch_product_new_arrival = "SELECT * FROM product WHERE product_tag LIKE '%new_arrival%' ORDER BY tag_order DESC";

      $result_new_arrival = $conn->query($sql_fetch_product_new_arrival);
      
      if ($result_new_arrival->num_rows > 0) {
        
          // output data of each row
          while($row = $result_new_arrival->fetch_assoc()) {
               ?>
