...
<div class="jumbotron jumbotron-fluid">
  <div class="container" style="padding: 5px;">
    <h4><strong>Bestsellers :</strong></h4><hr>
    <div class="row">
      <?php

      

      $sql_fetch_product_bestseller = "SELECT * FROM product WHERE product_tag LIKE '%bestseller%' ORDER BY tag_order DESC";

      $result_bestseller = $conn->query($sql_fetch_product_bestseller);
