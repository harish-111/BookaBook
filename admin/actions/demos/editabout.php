...
<html lang="en">
  ...
  <body>
  	...
  	<div class="container">
      <h6>Edit About content below : </h6>
      ...
      <div id="sample">
        ...
        <textarea name="about_content" cols="120" rows="10"></textarea>
        <br />
      </div>

    <input type="submit" name="about_content_submit" class="btn btn-dark">
      </form>
    </div>
  	...
  	$myfile = fopen("../../../footer/about.html", "w") or die("Unable to open file!");
    $header = '<!doctype html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
