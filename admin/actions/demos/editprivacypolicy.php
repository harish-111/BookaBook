...
<html lang="en">
  ...
  <body>
  	...
  	<div class="container">
      <h6>Edit Privacy Policy content below : </h6>
      ...
      <div id="sample">
        ...
        <textarea name="privacypolicy_content" cols="120" rows="10"></textarea>
        <br />
      </div>

    <input type="submit" name="privacy_content_submit" class="btn btn-dark">
      </form>
    </div>
   
   	<?php
   	$privacypolicy_content = $_POST['privacypolicy_content'];
  	$myfile = fopen("../../../footer/privacy_policy.html", "w") or die("Unable to open file!");
    $header = '<!doctype html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
    ...
    <title>Glamaroma | Privacy Policy</title>
  </head>
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <img class="navbar-brand img-fluid" src="../logo.png" width="15%">
    ...
    fwrite($myfile, $privacypolicy_content);
    $footer='</div><footer>
