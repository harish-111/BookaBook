...
<html lang="en">
  ...
  <body>
  	...
  	<div class="container">
      <h6>Edit Shipping Policy content below : </h6>
      ...
      <div id="sample">
        ...
        <textarea name="shippingpolicy_content" cols="120" rows="10"></textarea>
        <br />
      </div>

    <input type="submit" name="shippingpolicy_content_submit" class="btn btn-dark">
      </form>
    </div>
   
   	<?php
   	$shippingpolicy_content = $_POST['shippingpolicy_content'];
  	$myfile = fopen("../../../footer/shipping_policy.html", "w") or die("Unable to open file!");
    $header = '<!doctype html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
    ...
    <title>Glamaroma | Shipping Policy</title>
  </head>
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <img class="navbar-brand img-fluid" src="../logo.png" width="15%">
    ...
    fwrite($myfile, $shippingpolicy_content);
    $footer='</div><footer>
