...
<html lang="en">
  ...
  <body>
  	...
  	<div class="container">
      <h6>Edit Return Policy content below : </h6>
      ...
      <div id="sample">
        ...
        <textarea name="returnpolicy_content" cols="120" rows="10"></textarea>
        <br />
      </div>

    <input type="submit" name="returnpolicy_content_submit" class="btn btn-dark">
      </form>
    </div>
   
   	<?php
   	$returnpolicy_content = $_POST['returnpolicy_content'];
  	$myfile = fopen("../../../footer/return_policy.html", "w") or die("Unable to open file!");
    $header = '<!doctype html>
<html lang="en">
  <head>
    <!-- Required meta tags -->
    ...
    <title>Glamaroma | Return/Cancellation Policy</title>
  </head>
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <img class="navbar-brand img-fluid" src="../logo.png" width="15%">
    ...
    <h6>Return/Cancellation Policy : </h6>';
    fwrite($myfile, $header);
    fwrite($myfile, $returnpolicy_content);
    $footer='</div><footer>
